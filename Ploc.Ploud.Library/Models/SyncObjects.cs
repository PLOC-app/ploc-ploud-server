...
namespace Ploc.Ploud.Library
{
    public class SyncObjects
    {
        ...
        public PloudObjectCollection<IPloudObject> AllObjects(ICellar cellar)
        {
            ...
            if (this.Appellations != null && this.Appellations.Count > 0)
            {
            ...
            if (this.Classifications != null && this.Classifications.Count > 0)
            {
                allObjects.AddRange(this.Classifications);
            }

            if (this.BottleFormats != null && this.BottleFormats.Count > 0)
            {
                allObjects.AddRange(this.BottleFormats);
            }

            if (this.Grapes != null && this.Grapes.Count > 0)
            {
            ...
            if (this.GlobalParameters != null && this.GlobalParameters.Count > 0)
            {
                allObjects.AddRange(this.GlobalParameters);
            }

            if (this.Racks != null && this.Racks.Count > 0)
            {
                allObjects.AddRange(this.Racks);
            }

            if (this.RackItems != null && this.RackItems.Count > 0)
            {
            ...
            if (this.Wines != null && this.Wines.Count > 0)
            {
                allObjects.AddRange(this.Wines);
            }

            if (this.TastingNotes != null && this.TastingNotes.Count > 0)
            {
